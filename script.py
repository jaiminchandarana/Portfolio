# Create the complete updated style.css with profile image enhancements
css_content = """
:root {
    ...
    /* Enhanced variables for better theming */
...
/* Enhanced Resume Button Styling */
.nav-resume-btn {
    display: flex;
    align-items: center;
    gap: var(--space-8);
...
.hero::before {
    ...
    right: 0;
    bottom: 0;
    background: radial-gradient(circle at 20% 80%, rgba(var(--color-teal-500-rgb), 0.1) 0%, transparent 50%), 
                radial-gradient(circle at 80% 20%, rgba(var(--color-orange-500-rgb), 0.1) 0%, transparent 50%);
    pointer-events: none;
}
...
/* Enhanced Hero Section Profile Image */
...
.profile-image[src*="generated_image"] {
    opacity: 1;
}
...
# Continue with the rest of the CSS including all sections...
css_content += """
...
@media (max-width: 768px) {
    ...
    .experience-card { padding: var(--space-24); }
...
@media (max-width: 480px) {
    ...
    .hero { padding: 80px 0 var(--space-24); }
    ...
    .project-filters { gap: var(--space-8); }
    ...
    .experience-card { padding: var(--space-16); }

    .experience-content { gap: var(--space-16); }
    ...
    .responsibilities { gap: var(--space-12); }

    .responsibilities li { padding: var(--space-10); }

    .company-info { flex-wrap: wrap; }
}
...
print("✅ Complete style.css file created successfully!")
